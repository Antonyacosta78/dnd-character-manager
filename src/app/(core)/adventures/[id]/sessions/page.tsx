...
export default async function AdventureEntitySessionsPage({
  params,
}: {
  ...
  return (
    <section className="rounded-radius-sm border border-border-default bg-bg-surface p-4 shadow-shadow-soft">
      <p className="text-sm text-fg-secondary">{t("appShellNavigation.routeBody.adventureEntitySessions", { id })}</p>
    </section>
  );
}
