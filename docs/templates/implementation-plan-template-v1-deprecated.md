# Implementation Plan Template (v1, Deprecated)

> Deprecated: `2026-05-18`
>
> Do not use this template for new implementation plans.
> Use `docs/templates/implementation-plan-template.md` instead.
