...
- `2026-06-08` - `Antony Acosta` - Marked the rules-catalog publish/read spec as rolled back after active rules-catalog runtime code was removed from the repo in Step 7. Made with OpenCode.
